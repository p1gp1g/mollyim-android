...
android {
  ...
  productFlavors {
    ...
    create("dev") {
      ...
      buildConfigField("String", "SIGNAL_URL", "\"https://whisper.flatline.internal\"")
      buildConfigField("String", "STORAGE_URL", "\"https://storage.flatline.internal\"")
      buildConfigField("String", "SIGNAL_CDN_URL", "\"https://cdn0.flatline.internal\"")
      buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://invalid-e3cc69\"")
      buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://cdn3.flatline.internal\"")
      buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://invalid-36ae99\"")
      buildConfigField("String", "SIGNAL_SERVICE_STATUS_URL", "\"uptime.signal.org\"")
      buildConfigField("String", "SIGNAL_SVR2_URL", "\"https://invalid-3bd5ac\"")
      buildConfigField("String", "SIGNAL_SFU_URL", "\"https://sfu.flatline.internal\"")
      buildConfigField("String", "SIGNAL_STAGING_SFU_URL", "\"https://invalid-51ea90\"")
      buildConfigField("String[]", "SIGNAL_SFU_INTERNAL_NAMES", "new String[]{\"Test\", \"Staging\", \"Development\"}")
      buildConfigField("String[]", "SIGNAL_SFU_INTERNAL_URLS", "new String[]{\"https://invalid-5cb882\", \"https://invalid-8590a4\", \"https://invalid-b30923\"}")
      buildConfigField("String", "CONTENT_PROXY_HOST", "\"invalid-d437b8\"")
      buildConfigField("int", "CONTENT_PROXY_PORT", "443")
